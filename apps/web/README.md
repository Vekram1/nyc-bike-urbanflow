...
- E2E runtime snapshot for browser-driven checks:
  ...
  - `window.__UF_E2E.inspectLastOpenedStationId`
  - `window.__UF_E2E.inspectLastClosedStationId`
  ...
  - `window.__UF_E2E.mapRefreshLastHttpStatus`
  - `window.__UF_E2E.mapRefreshLastErrorHttpStatus`
  ...
  - `window.__UF_E2E.mapFeatureStateLastSetAt`
  - `window.__UF_E2E.mapFeatureStateLastClearAt`
  - `window.__UF_E2E.mapFeatureStateLastErrorAt`
  - `window.__UF_E2E.tier1OpenedCount`
  - `window.__UF_E2E.tier1LastOpenedAt`
  ...
  - `window.__UF_E2E.tier2LastRequestedAt`
  - `window.__UF_E2E.tier2LastSuccessAt`
  - `window.__UF_E2E.tier2LastErrorAt`
